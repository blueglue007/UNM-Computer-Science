...
def main():
    ...
    print "Running csim-score.py"
    #"./test-csim" "bash test-csim.sh"
    p = subprocess.Popen("python csim-score.py",
    ...
    if csim_cscore[0] == 14 and trans32_score == 8:
        print "Lab Credit Complete 1/1"
    else:
        print "Lab Credit Incomplete 0/1"
    bonus1 = ""
    bonus2 = ""
    if trans61_score == 10:
        bonus1 = "Transpose 61x67 +1 bonus point"

    if trans64_score == 8:
        bonus2 = "Transpose 61x67 +1 bonus point"
